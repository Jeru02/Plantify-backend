...
const like_plants_test_data_1 = __importDefault(require("../data/test-data/like_plants.test-data"));
const runSeed = () => {
    return (0, seed_1.default)(plants_development_data_1.default, quiz_development_data_1.default, users_test_data_1.default, like_plants_test_data_1.default).then(() => connection_1.default.end());
};
runSeed();
